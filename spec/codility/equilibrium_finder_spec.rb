...
RSpec.describe 'Equilibrium' do
  ...
  describe Codility::FasterFinder do
    include_examples :equilibrium, Codility::FasterFinder, 1000
  end

  describe Codility::EquilibriumFinder do
    include_examples :equilibrium, Codility::EquilibriumFinder, 15
  end
